...
In Step 3, you will implement the other two print methods, in-order and post-order. In Step 4 you will implement the sum, count and contains methods. In Step 4, you will implement the predecessor, successor, and remove methods. Step 5 will likely take you the most time BY FAR, so plan accordingly.
